...
function Modal() {
    ...
    const uploadPost = async () => {
        ...
        //Create a post, add to firestore 'posts' collection, get post id for the post created, upload image to firebase storage with post id, 
        // download url from firebase, upload to post
